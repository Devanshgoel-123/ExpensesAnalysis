  ...
  useEffect(() => {
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uOpacity: { value: 1.0 },
        uCableColor: { value: new Float32Array([0.498, 0.902, 0.651]) },
        uPulseColor: { value: new Float32Array([0.498, 0.902, 0.651]) },
        uTunnelColor: { value: new Float32Array([0.09, 0.69, 0.38]) },
